...
class ExamplePredictorFusion2(BasePredictorModel):
    ...
    def load(self):
        ...
        self.model_cip_GBM    = joblib.load('my_models/models/LightGBM/Carbon_Intensity_Power_model_hyper.h5')
        self.model_sg_GBM     = joblib.load('my_models/models/LightGBM/solar_generation_model_hyper.h5')
    ...
    def compute_forecast(self, observations):
        ...
        for i,b_name in enumerate(self.building_names):            
            ...
            # Change the shape for the LSTM Model
            ...
            #---------------------------------------------------------------------------------------------------------
            # LSTM Model predictions for the house level
            if i > 2:
